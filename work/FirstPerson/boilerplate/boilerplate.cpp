...
void triangulateSphere(float originX, float originY, float radius, vector<vec3>* data){
	float phiNum = 20;
...
int main(int argc, char *argv[])
{
	...
	triangulateSphere(.0f,.0f,0.5f,&testSphere);
	...
	if(!LoadGeometry(&testGeometry, testSphere.data(), testSphere.size()))
		cout << "Failed to load geometry" << endl;
